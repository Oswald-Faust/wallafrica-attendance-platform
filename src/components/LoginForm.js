  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-purple-100">
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-0">
        ...
        >
          <h1 className="text-2xl lg:text-3xl font-bold mb-4 lg:mb-6 text-center text-purple-800">Vous connecter</h1>
          <p className="text-center text-gray-600 mb-4 lg:mb-6">Bon retour sur WallPlatforms </p>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">Continuer avec</span>
              </div>
            </div>
